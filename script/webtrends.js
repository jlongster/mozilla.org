...
WebTrends.prototype.dcsVar=function()
{
	...
	WT.jv=(function()
	{
		...
		var ie5up=(ie&&!ie4);
		var op=(agt.indexOf("opera")!=-1);var op5=(agt.indexOf("opera 5")!=-1||agt.indexOf("opera/5")!=-1);
...
WebTrends.prototype.dcsChk=function(){if(this.rate==100){return"true";}
var cname='wtspl';cval=this.dcsGetCookie(cname);if(cval==null){cval=Math.floor(Math.random()*1000000);var date=new Date();date.setTime(date.getTime()+(30*24*60*60*1000));document.cookie=cname+"="+cval+"; expires="+date.toGMTString()+"; path=/; domain="+this.fpcdom+";";}
