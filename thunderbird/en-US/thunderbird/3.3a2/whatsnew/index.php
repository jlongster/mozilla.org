...
<p>Thanks for testing Miramar Alpha 2</p>
</div>
<p><strong>What's New in Miramar Alpha 2</strong></p>
...
<p>Miramar Alpha 2 is built on top of the Gecko 2.0 platform. The main goals of this release is to find out about possible problems caused by the changes in the underlying platform.</p>
<p>Notable change in Miramar Alpha 2 since Miramar Alpha 1:</p>
<ul class="spaced">
  <li>New Troubleshooting information page to aid supporting and diagnosing problems in Thunderbird</li>
  <li>Notifications of add-on installation progress and issues now work correctly</li>
  <li>Attachment reminder now works again</li>
  <li>Attachment sizes are now available in the compose window</li>
...
<ul class="spaced">
  ...
  <li>Over 280 platform fixes to improve performance and stability</li>
</ul>
<p>For a more detailed list of bug fixes, see the <a href="https://bugzilla.mozilla.org/buglist.cgi?quicksearch=ALL%20+milestone:%22Thunderbird%203.3a2%22%20+resolution:FIXED%20-status-thunderbird3.1:fixed%20-status-thunderbird3.0:fixed">the full bug list</a>.</p>
<p>We appreciate your support in helping us test and evaluate
  Miramar Alpha 2.&nbsp; Please read the <a
 href="/thunderbird/3.3a2/releasenotes/">release
    notes</a> before using this preview release.&nbsp; Please leave feedback specific to Miramar Alpha 2 on <a href="http://getsatisfaction.com/mozilla_messaging/topics/miramar_alpha_2_feedback_topic">this thread on our getsatisfaction site</a>. or by filing a bug in bugzilla using these <a
