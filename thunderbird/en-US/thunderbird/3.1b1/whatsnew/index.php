...
<head>
  ...
  <title>What’s New in Lanikai</title>
  <style type="text/css">
  body {
    margin: 0;
    padding: 0;
  ...
  #contents {
    ...
    background: url(<?php echo data_url('../../../../img/thunderbird/start/main-feature-lanikai.jpg','image/jpeg'); ?>) top right no-repeat;
  }
...
<body>
 ...
 src="<?php echo data_url('../../../../img/thunderbird/start/whats-new-lanikai.png','image/png'); ?>"
 alt="What’s New in Thunderbird" /></h1>
<p>Thanks for testing Lanikai Beta 1</p>
</div>
<p><strong>What's New in Lanikai Beta 1</strong></p>
...
<p>Lanikai Beta 1 is built on top of the Gecko 1.9.2 platform. The main goals of this release is to find out about possible problems
    caused by the changes in the underlying platform.  Notable changes include:</p>
<ul class="spaced">
  <li>Several fixes to improve upgrading from Thunderbird 2.</li>
  <li>Several fixes for auto complete, tabs, and activity manager.</li>
  <li>Several design improvements and corrections to the interface.</li>
  <li>Stability and memory improvements.</li>
</ul>
<p>For a more detailed list of bug fixes, see the <a href="https://bugzilla.mozilla.org/buglist.cgi?query_format=advanced;resolution=FIXED;target_milestone=Thunderbird 3.1b1">the full bug list</a>.</p>
<p>The Rumbling Edge has a more detailed list of <a href="http://www.rumblingedge.com/2010/03/08/thunderbird-3-1-beta-1-released/">notable bug fixes</a>.</p>
...
<p>We appreciate your support in helping us test and evaluate
  Lanikai Beta 1.&nbsp; Please read the <a
 href="/thunderbird/3.1b1/releasenotes/">release
    notes</a> before using this preview release.&nbsp; If you have
  feedback, please send it to us by visiting our <a
 href="news://news.mozilla.org/mozilla.feedback.thunderbird.prerelease">newsgroup</a> or by filing a bug in bugzilla using these <a
