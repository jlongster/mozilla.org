...
$releasenotes_31_link = url('/thunderbird/3.1.3/releasenotes/');
$releasenotes_30_link = url('/thunderbird/3.0.7/releasenotes/');
...
<p>
Thunderbird 3.1.3 and Thunderbird 3.0.7 updates are now available for Windows, Mac, and Linux for free download from <a href="$download_link">www.GetThunderbird.com</a>.  These releases make several improvements to Thunderbird's security and product stability.</p>
<p>
...
<p>For a list of changes and more information, please review the Thunderbird 3.1.3 <a href="$releasenotes_31_link">release notes</a> or the Thunderbird 3.0.7 <a href="$releasenotes_30_link">release notes</a>.</p>
