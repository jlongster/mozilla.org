...
// the prefix must match the value used in enable.js.  In this case, "wairole:"
...
/* perform any initialization for treeItems */
function initTreeItem(elmAccessible) {
 // first item may need to be a tab stop.  include "firstTS" in its id attribute
	      if (/firstTS/.test(elmAccessible.id)) {
	        elmAccessible.tabIndex="0";
	      }
	      else if (elmAccessible.tabIndex <= 0) {
