...
<div id="footer-wrap">
    <div id="footer" class="cols">
        ...
        <div class="col-span">
            <?php MozillaOrg_SvnHistoryLink::display('Page History'); ?> — <a href="https://wiki.mozilla.org/Mozilla.org/Editing_Site_with_SVN#Making_Site_Changes">Edit this Page</a>
        </div>
        <div class="five-col">
