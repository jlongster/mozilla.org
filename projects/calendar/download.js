...
var gLanguages = {
  ...
  "ca":  { "-":  { sb: "1.0b4",ln: null,   name: "Catalan",                  localName: "català-valencià" } },
  "cs":  { "-":  { sb: "1.0b4",ln: null,   name: "Czech",                    localName: "\u010Ce\u0161tina" } },
  "cy":  { "gb": { sb: null, ln: null,   name: "Welsh",                      localName: "Cymraeg" } },
  "da":  { "-":  { sb: "1.0b4",ln: null,   name: "Danish",                   localName: "Dansk" } },
  "de":  { "-":  { sb: "1.0b4",ln: null,   name: "German",                   localName: "Deutsch" } },
  "el":  { "-":  { sb: null, ln: null,   name: "Greek",                      localName: "\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AE" } },
  "en":  { "us": { sb: "1.0b4",ln: null,   name: "English",                  localName: "English" },
           "gb": { sb: null, ln: null,   name: "English (British)",          localName: "English (British)" } },
  "es":  { "ar": { sb: "1.0b4",ln: null,   name: "Spanish (Argentina)",      localName: "Español (Argentina)" },
           "es": { sb: "1.0b4",ln: null,   name: "Spanish (Spain)",          localName: "Español (de España)" } },
  "et":  { "-":  { sb: "1.0b4",ln: null,   name: "Estonian",                 localName: "Eesti keel" } },
  "eu":  { "-":  { sb: "1.0b4",ln: null,   name: "Basque",                   localName: "Euskara" } },
  "fi":  { "-":  { sb: null, ln: null,   name: "Finnish",                    localName: "Suomi" } },
  "fr":  { "-":  { sb: "1.0b4",ln: null,   name: "French",                   localName: "Français" } },
  "fy":  { "nl": { sb: "1.0b4", ln: null,   name: "Frisian",                 localName: "Frysk" } },
  "ga":  { "ie": { sb: "1.0b4",ln: null,   name: "Irish",                    localName: "Gaeilge" } },
  "gl":  { "-":  { sb: "1.0b4",ln: null,   name: "Galician",                 localName: "Galego" } },
  "gu":  { "in": { sb: null, ln: null,   name: "Gujarati",                   localName: "\u0A97\u0AC1\u0A9C\u0AB0\u0ABE\u0AA4\u0AC0" } },
  "he":  { "-":  { sb: "1.0b4", ln: null,   name: "Hebrew",                  localName: "\u05E2\u05D1\u05E8\u05D9\u05EA" } },
  "hu":  { "-":  { sb: "1.0b4",ln: null,   name: "Hungarian",                localName: "Magyar" } },
  "hy":  { "am": { sb: null, ln: null,   name: "Armenian",                   localName: "\u0540\u0561\u0575\u0565\u0580\u0565\u0576" } },
  "id":  { "-":  { sb: "1.0b4",ln: null,   name: "Indonesian",               localName: "Bahasa Indonesia" } },
  "is":  { "-":  { sb: "1.0b4",ln: null,   name: "Icelandic",                localName: "Íslenska" } },
  "it":  { "-":  { sb: "1.0b4",ln: null,   name: "Italian",                  localName: "Italiano" } },
  "ja":  { "-":  { sb: "1.0b4",ln: null,   name: "Japanese",                 localName: "\u65E5\u672C\u8A9E" } },
  "ka":  { "-":  { sb: "1.0b4",ln: null,   name: "Georgian",                 localName: "\u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8" } },
  "ko":  { "-":  { sb: "1.0b4",ln: null,   name: "Korean",                   localName: "\uD55C\uAD6D\uC5B4" } },
  "lt":  { "-":  { sb: "1.0b4",ln: null,   name: "Lithuanian",               localName: "Lietuvi\u0173" } },
  "mk":  { "-":  { sb: null, ln: null,   name: "Macedonian",                 localName: "\u041C\u0430\u043A\u0435\u0434\u043E\u043D\u0441\u043A\u0438" } },
  "mn":  { "-":  { sb: null, ln: null,   name: "Mongolian",                  localName: "\u041C\u043E\u043D\u0433\u043E\u043B" } },
  "nb":  { "no": { sb: "1.0b4",ln: null,   name: "Norwegian (Bokmål)",       localName: "Norsk bokmål" } },
  "nn":  { "no": { sb: "1.0b4",ln: null,   name: "Norwegian (Nynorsk)",      localName: "Norsk nynorsk" } },
  "nl":  { "-":  { sb: "1.0b4",ln: null,   name: "Dutch",                    localName: "Nederlands" } },
  "pa":  { "in": { sb: "1.0b4", ln: null,   name: "Punjabi",                 localName: "\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40" } },
  "pl":  { "-":  { sb: "1.0b4",ln: null,   name: "Polish",                   localName: "Polski" } },
  "pt":  { "br": { sb: "1.0b4",ln: null,   name: "Portuguese (Brazilian)",   localName: "Português (do Brasil)" },
           "pt": { sb: "1.0b4",ln: null,   name: "Portuguese (Portugal)",    localName: "Português (Europeu)" } },
  "ro":  { "-":  { sb: "1.0b4",ln: null,   name: "Romanian",                 localName: "român\u0103" } },
  "ru":  { "-":  { sb: "1.0b4",ln: null,   name: "Russian",                  localName: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439" } },
  "si":  { "-":  { sb: "1.0b4",ln: null,   name: "Sinhala",                  localName: "Sinhala" } },
  "sk":  { "-":  { sb: "1.0b4",ln: null,   name: "Slovak",                   localName: "sloven\u010Dina" } },
  ...
  "zh":  { "cn": { sb: "1.0b4",ln: null,   name: "Chinese (Simplified)",     localName: "\u4E2D\u6587 (\u7B80\u4F53)" },
